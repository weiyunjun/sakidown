...
- **搜索任务**：你可以在顶部搜索栏输入关键词搜索任务，支持搜索合集标题、分组标题、标题和UP主名称。
- **批量管理**：点击顶栏的批量管理按钮，可以进入批量管理模式。批量管理模式主要用于批量取消、删除和重试任务。批量管理可以配合搜索使用。处于批量管理模式中，再次点击批量管理按钮，可以退出批量管理。
- **每页任务**：在页面底部有每页任务的设置，默认每页25个任务，可以改为每页10、25、50、100个任务。
### 设置
